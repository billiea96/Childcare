...
$html.= '
	<table nobr="true" style="border-collapse:collapse;" border="0" align="center" cellpadding="5">
		<tr>
			...
			<td width="60%" colspan="4" style="font-size:18px;font-weight:bold;">Laporan Pengeluaran '.date("F Y",strtotime($tanggal)).'</td>
		</tr>
		<tr>
...
$html= '
	<table style="border-collapse:collapse;" border="1" align="center" cellpadding="5">
		<tr>
			...
			<th align="center" width="20%" style="font-weight:bold;">Keperluan</th>
			<th align="center" width="35%" style="font-weight:bold;">Keterangan</th>
			<th align="center" width="20%" style="font-weight:bold;">Biaya</th>
		</tr>';
$count=0;
foreach ($laporan as $key => $value) {
	...
	$html.='
		<tr>
			...
			<td align="center">Rp. '.number_format($value["JumlahBayar"]).'</td>
		</tr>
	';
}

if($count==0){
	$html.='<tr><td colspan="6">Tidak ada pengeluaran pada tanggal ini</td></tr>';
}
