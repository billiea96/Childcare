...
$pdf->SetTitle('Laporan Katering');
$pdf->SetSubject('Laporan Katering');
...
$html.= '
	<table nobr="true" style="border-collapse:collapse;" border="0" align="center" cellpadding="5">
		<tr>
			...
			<td width="60%" colspan="4" style="font-size:18px;font-weight:bold;">Laporan Katering</td>
		</tr>
		<tr>
			<td align="left" width="10%">Bulan</td>
			<td align="left" width="50%">: '.date("F Y",strtotime($katering[0]["Tanggal"])).'</td>
		</tr>
		<tr>
...
$html= '
	<table style="border-collapse:collapse;" border="1" align="center" cellpadding="5">
		<tr>
			<th align="center" width="20%" style="font-weight:bold;">Tanggal</th>
			<th align="center" width="20%" style="font-weight:bold;">Nama Paket</th>
			<th align="center" width="25%" style="font-weight:bold;">Nama Makanan</th>
			<th align="center" width="35%" style="font-weight:bold;">Bahan</th>
		</tr>';
$count=0;
$id ='';
foreach ($katering as $key => $value) {
	$count++;
	if($id!=$value["Id"]){
		$id=$value["Id"];
		$html.='
			<tr>
				<td rowspan="'.$value["Jumlah"].'" style="verticel-align:middle;"><span style="font-size: 10px;">'.str_repeat('&nbsp;<br/>', $value["Jumlah"]-1).'</span>'.date("d-m-Y",strtotime($value["Tanggal"])).'</td>
				<td rowspan="'.$value["Jumlah"].'" style="verticel-align:middle;"><span style="font-size: 10px;">'.str_repeat('&nbsp;<br/>', $value["Jumlah"]-1).'</span>'.$value["NamaPaket"].'</td>
				<td>'.$value["NamaMakanan"].'</td>
				<td>'.$value["Bahan"].'</td>
			</tr>';
...
ob_clean();
$namaFile='Laporang Katering-'.$anak["Nama"];
