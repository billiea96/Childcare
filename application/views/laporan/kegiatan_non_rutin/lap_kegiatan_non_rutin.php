...
$pdf->SetTitle('Laporan Kegiatan Non Rutin');
$pdf->SetSubject('Laporan Kegiatan Non Rutin');
...
$html.= '
	<table nobr="true" style="border-collapse:collapse;" border="0" align="center" cellpadding="5">
		<tr>
			...
			<td width="60%" colspan="4" style="font-size:18px;font-weight:bold;">Laporan Kegiatan Non Rutin</td>
		</tr>
		<tr>
...
$html= '
	<table style="border-collapse:collapse;" border="1" align="center" cellpadding="5">
		<tr>
			...
			<th align="center" width="25%" style="font-weight:bold;">Kegiatan</th>
			<th align="center" width="30%" style="font-weight:bold;">Detail Kegiatan</th>
			<th align="center" width="40%" style="font-weight:bold;">Catatan</th>
		</tr>';
$count=0;
...
if($count==0){
	$html.='<tr><td colspan="4">Belum ada kegiatan pada tanggal ini</td></tr>';
}
...
ob_clean();
$namaFile='Laporan Kegiatan Non Rutin -'.$anak['Nama'];
